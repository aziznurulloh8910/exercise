...
WHERE YEAR(orders.orderDate) = ".$tahun." AND MONTH(orders.orderDate) = ".$bulan."
...
<div class="card shadow-sm p-2 mb-3 mt-4">
  <?php echo "<h5> Bulan : ".$bulan.", Tahun :".$tahun." </h5>" ?>
</div>
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">10 Produk terlaris PerBulan</h6>
  </div>
  <div class="card-body">
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="chart-bar">
      <canvas id="chart-terlaris-perBulan"></canvas>
    </div>
    <hr>
...
<script>
  $('.table').DataTable();
  const terlarisPerBulan = document.getElementById('chart-terlaris-perBulan');
  new Chart(terlarisPerBulan, {
    type: 'bar',
    data: {
